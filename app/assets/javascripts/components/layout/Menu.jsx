    ...
    if (this.props.signedIn) {
      var signingLink =
        <span id={this.props.signedIn}>
            <a className="align-wrapper debugger1" href={'/signout'}><i className="debugger1 material-icons valign">input</i><span className="sign-in-out-margin-left">Sign Out</span></a>
        </span>;
    } else {
      var signingLink =
        <span id={this.props.signedIn}>
