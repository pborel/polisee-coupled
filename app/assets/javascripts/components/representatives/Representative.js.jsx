  ...
  render: function() {
    ...
    return (
      <div className="card rep-card hoverable">
      	...
      	<ButtonSpace parentComponent={this} tweet_link={handle} twitter_handle={this.props.data.twitter_id} data={this.props.data} facebook_link={facebook} fundingInfoActive={this.state.fundingInfoActive} />
