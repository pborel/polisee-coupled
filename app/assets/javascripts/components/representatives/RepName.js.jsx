var RepName = React.createClass({
	render: function() {
		...
		<div className="card-content">
			<span className="card-title activator grey-text text-darken-4">{this.props.first_name} {this.props.last_name}<i className="material-icons right">more_vert</i></span>
		</div>
		)
	}
})
