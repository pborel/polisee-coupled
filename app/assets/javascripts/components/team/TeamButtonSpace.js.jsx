  ...
  render: function() {
    return (
      <div className="card-action centered">
        { this.props.data.website_url ? <a href={this.props.data.website_url} className="waves-effect btn-flat-large rep-follow-button"><img src="https://maxcdn.icons8.com/Color/PNG/48/Messaging/link-48.png" title="Link" width="48"/></a> : null }
