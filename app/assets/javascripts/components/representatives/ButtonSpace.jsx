...
// 	render: function() {
// 		return (
// 			<div className="card-action debugger button-container centered">
//         <Twitter />
...
//         <a className="waves-effect waves-light btn" onClick={this.props.parentComponent.toggleFundingInfo()}><i className="material-icons left">cloud</i>Funding Info</a><br/>
//         { this.props.fundingInfoActive ? <FundingInfo /> : null }<br/>
// 			</div>
// 		)
// 	}
// })
